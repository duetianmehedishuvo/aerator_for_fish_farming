  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer2<LocationProvider, WeatherProvider>(
        builder: (context, locationProvider, weatherProvider, child) => SafeArea(
          child: StreamBuilder(
                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: [
                            ...
                            eachRow("Dissolved Oxygen", "${snapshot.data!.snapshot.child('SENSOR_DATA').children.elementAt(5).value.toString()}M/gm"),
